            ...
            return (
              ...
              >
                <div
                  ...
                  style={{
                    background: `radial-gradient(circle, rgba(255,255,255,0.2) 0%, rgba(255,255,255,0.7)%)`,
                    width: `${item.energy * 0.5 + 40}px`,
                    height: `${item.energy * 0.5 + 40}px`,
                    left: `-${(item.energy * 0.5 + 40) / 2}px`,
                    top: `-${(item.energy * 0.5 + 40) / 2}px`,
                  }}
                ></div>
                ...
                >
                  {React.isValidElement(Icon) && (
                    <div className="flex items-center">
                      {React.cloneElement(Icon as React.ReactElement, { size: 16, className: "mr-1" })}
