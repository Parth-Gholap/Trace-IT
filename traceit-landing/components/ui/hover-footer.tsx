...
const HoverFooter = ({ className }: HoverFooterProps) => {
  const footerLinks = [
    {
      title: "About Us",
      links: [
  ...
  const contactInfo = [
    {
      ...
      text: "hello@traceit.com",
      href: "mailto:hello@traceit.com",
    },
    {
  ...
  return (
    <footer className={cn("bg-[#0F0F11]/10 relative h-fit rounded-3xl overflow-hidden m-8", className)}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-8 lg:gap-16 pb-12">
          ...
          <div className="flex flex-col space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-white text-3xl font-bold">TraceIT</span>
            </div>
            <p className="text-sm leading-relaxed">
              TraceIT is a community-powered lost and found platform that helps people reconnect with their belongings.
            </p>
          </div>
      ...
      <div className="lg:flex hidden h-[30rem] -mt-52 -mb-36">
        <TextHoverEffect text="TraceIT" className="z-50" />
      </div>
